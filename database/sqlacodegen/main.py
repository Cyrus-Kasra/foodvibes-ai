...
def main():
    ...
    parser.add_argument(
        "--nojoined", action="store_true", help="don't autodetect joined table inheritance"
    )
    parser.add_argument(
        "--noinflect",
        action="store_true",
    ...
    parser.add_argument(
        "--notables", action="store_true", help="don't generate tables, only classes", default=True
    )
    parser.add_argument("--outfile", help="file to write output to (default: stdout)")
    parser.add_argument("--nobackrefs", action="store_true", help="don't include backrefs")
    parser.add_argument(
        "--flask", action="store_true", help="use Flask-SQLAlchemy columns", default=True
    )
    parser.add_argument(
        "--ignore-cols",
    ...
    parser.add_argument(
        "--dataclass", action="store_true", help="add dataclass decorators for JSON serialization"
    )
