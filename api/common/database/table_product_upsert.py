...
from api.common.types import CommonError, CommonQueryParams, CommonQueryResponse, DatabaseOperation
...
def product_upsert_db(
    ...
    if ledger_id >= 0:
        ...
        row_new = {
            ...
            "image_id": "product/" + (item.image_id or f"{uuid4()}").replace("product/", ""),
        }
