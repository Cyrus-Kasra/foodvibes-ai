...
async def main(user_name: str):
    ...
    glo1 = await sc_user_item_create(
        "vaishnavi.ranganathan@microsoft.com",
        "vaishnavi.ranganathan@microsoft.com",
        "425-555-1000",
        ROLE_GLOBAL_OWNER,
        "system",
    )
    glo2 = await sc_user_item_create(
        "brunosilva@microsoft.com",
        "brunosilva@microsoft.com",
        "425-555-1000",
        ROLE_GLOBAL_OWNER,
        "system",
    ...
    if len(user_name) > 0:
        ...
        glo3 = await sc_user_item_create(
            user_name,
            user_name,
            "425-555-1000",
            ROLE_GLOBAL_OWNER,
        ...
        logger.warning(f"Not adding a default global owner (needs to be added manually)")
        glo3 = -1
